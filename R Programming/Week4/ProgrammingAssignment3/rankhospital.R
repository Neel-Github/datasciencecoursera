rankhospital<- function(state, outcome, num = "best")
{
  ...
  outcome2[ ,colnum] <- as.numeric(outcome2[ ,colnum])          ##converts to numeric vector
  outcome3 <- outcome2[order(outcome2[ ,colnum],outcome2[,2]), ]##first by value at column,,,then by name in event of a clash
